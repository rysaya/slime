    ...
    def process_datas(self, datas):
        ...
        for data in datas:
            ...
            if self.args.chat_template:
                ...
                chosen_ids = self.tokenizer.apply_chat_template(cho_mes, tools, tokenize=True, return_tensors="pt")[0]
                rejected_ids = self.tokenizer.apply_chat_template(rej_mes, tools, tokenize=True, return_tensors="pt")[
                    0
                ]
